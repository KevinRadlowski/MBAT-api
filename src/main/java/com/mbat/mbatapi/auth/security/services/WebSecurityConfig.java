  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
            ...
            .authorizeHttpRequests(auth -> auth
                    .antMatchers("/api/auth/**", "/oauth2/**", "/api/password/**", "/api/unlock/**", "/api/user/check-email/**", "/api/user/signup", "/api/user/verify-email", "/api/user/verify-email/email", "/api/twofactor/**", "/api/twofactor/enable-2fa/email").permitAll()
